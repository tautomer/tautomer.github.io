...
![Logo](/images/3d_printing/logo-no-background.svg)

Here is the resulting QR code.

{:style="max-width: 500px; margin: auto"}
![Code](/images/3d_printing/qr-code.svg)
...
![Wrong logo coordinates](/images/3d_printing/imported.png)
...
{:style="max-width: 800px; margin: auto"}
![Fixed](/images/3d_printing/fixed_coordinates.png)
...
1. Select all vertices and merge overlapping ones. As the original svg has paths
   ...
   ![Merge by distance](/images/3d_printing/merge_by_distance.png)
...
2. Remove unnecessary colinear vertices with limited dissolve. Many vertices are
   ...
   {:style="max-width: 1000px; margin: auto"}
   ![Dissolved](/images/3d_printing/limited_dissolve.png)
   ...
   {:style="max-width: 1000px; margin: auto"}
   ![Weird faces](/images/3d_printing/weird_faces.png)
...
{:style="max-width: 800px; margin: auto"}
![Model](/images/3d_printing/extruded.png)
...
{:style="max-width: 800px; margin: auto"}
![Beveled base](/images/3d_printing/bevel.png)
...
{:style="max-width: 800px; margin: auto"}
![Removable logo](/images/3d_printing/boolean.png)
...
{:style="max-width: 800px; margin: auto"}
![Matching the physical size](/images/3d_printing/P1011662-Enhanced-NR-HDR.jpg)
...
{:style="max-width: 500px; margin: auto"}
![Test scanning](/images/3d_printing/P1011672-Enhanced-NR.jpg)
...
{:style="max-width: 800px; margin: auto"}
![G-code](/images/3d_printing/cura.png)
...
{:style="max-width: 800px; margin: auto"}
![Printing](/images/3d_printing/P1011675-Enhanced-NR.jpg)

{:style="max-width: 800px; margin: auto"}
![Code printed](/images/3d_printing/P1011677-Enhanced-NR.jpg)
...
{:style="max-width: 500px; margin: auto"}
![Coating](/images/3d_printing/P1011678-Enhanced-NR.jpg)
...
{:style="max-width: 800px; margin: auto"}
![Glued](/images/3d_printing/P1011516-Enhanced-NR.jpg)
...
{:style="max-width: 800px; margin: auto"}
![Final](/images/3d_printing/P1011514-Enhanced-NR.jpg)
